  ...
  const renderLink = (item: NavItem, isMobile = false) => {
    ...
    return (
      ...
      >
        ...
        {!isMobile && (
          <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-teal-600 to-teal-900 transition-all duration-300 group-hover:w-full [.text-teal-500_&]:w-full" />
        )}
      </ScrollLink>
    );
  };
